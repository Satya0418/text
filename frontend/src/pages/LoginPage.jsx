  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-primary/70">Please enter your details to login.</p>
      </div>
      ...
      <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
        ...
        <Input 
          ...
          required 
          labelRight={
            <Link to="/forgot-password" underline="none" className="font-semibold text-accent hover:text-accent-dark transition-colors">
              Forgot password?
            </Link>
          }
        />
