  ...
  return (
    <div className="min-h-screen bg-[#F6F3ED] flex items-center justify-center px-4 py-12">
      ...
      >
        ...
        {/* Heading */}
        <h1 className="text-2xl font-extrabold text-[#313851] text-center mb-1">Create your account</h1>
        <p className="text-sm text-[#313851]/60 text-center mb-8">Start extracting structured data in minutes</p>

        {/* Form */}
        <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-5">
          {/* Full Name */}
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-bold text-[#313851]/70 uppercase tracking-wider">Full Name</label>
            <input 
              type="text" 
          ...
          {/* Terms */}
          <p className="text-xs text-[#313851]/50 leading-relaxed">
            By creating an account, you agree to our{' '}
            <a href="#" className="text-[#6366F1] hover:underline font-medium">Terms of Service</a>{' '}and{' '}
            <a href="#" className="text-[#6366F1] hover:underline font-medium">Privacy Policy</a>.
          </p>
        ...
        <p className="text-center text-sm text-[#313851]/60 mt-8">
          ...
          <Link to="/login" className="font-bold text-[#6366F1] hover:underline">Log in</Link>
        </p>
      </motion.div>
    </div>
  );
